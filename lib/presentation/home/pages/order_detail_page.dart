...
import 'package:flutter_wisata_app/presentation/home/dialogs/payment_transfer_dialog.dart';
                    ...
                    child: Button.filled(
                      onPressed: () {
                        orderItems.forEach((item) {
                          print(
                              item); // Akan mencetak hasil dari item.toString() jika sudah di-override
                        });
                        if (paymentButtonIndex == 0) {
                          ...
                          // Membuat data transaksi untuk dialog Transfer
                          final grossAmount =
                              totalPrice; // Kirimkan hanya grossAmount (totalPrice)
                          print({'grossAmount': grossAmount});
                          showDialog(
                            context: context,
                            builder: (context) => TransferDialog(
                              grossAmount:
                                  grossAmount, // Hanya mengirimkan grossAmount
                            ),
                          );
                        }
                      },
